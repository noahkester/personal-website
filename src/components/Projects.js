    ...
    if (width > 1064) {
        return (
            <div id="projects" className="projects">
                <div className="projects-title">
                    ...
                    <div className="description-text project-description" data-aos="fade-up">In my free time I love creating projects that allow me to explore my creative side and passion for UI/UX. Try some of them out and learn more about them below</div>

                    <Project classes="general-container project-info-right" title="Nexus App" image_src={pgn_apps} link="pgn-app-blog" fade="fade-right" description="App for college organizations that tracks member status, events, and points for 100+ members" />
        ...
        return (
            <div id="projects" className="projects">
                <div className="projects-title">
                    <div className="subheading-text" data-aos="fade-up">Projects</div>
                    <div className="description-text project-description-mobile" data-aos="fade-up">In my free time I love creating projects that allow me to explore my creative side and passion for UI/UX. Try some of them out and learn more about them below</div>
