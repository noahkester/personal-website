...
function Setup() {
    return (
        <div className="awesome-blog-component" id = "awesome-setup">
...
function Client() {
    return (
        <div className="awesome-blog-component" id = "awesome-client">
            ...
            <img src={dashboard} className="awesome-blog-component"></img>
            ...
            <img src={track} className="awesome-blog-component"></img>
        </div>
    );
}
function Server() {
    return (
        <div className="awesome-blog-component" id = "awesome-server">
            ...
            <img src={login} className="awesome-blog-component"></img>
            ...
            <img src={server} className="awesome-blog-component" style={{ "paddingBottom": "50px" }}></img>
        </div>
    );
}
    ...
    return (
        <div>
            ...
            <div className="awesome">
                <img src={amc} className="awesome-image" style={{ "paddingBottom": "100px" }}></img>
                <Line />
                <div className="awesome-title awesome-blog-component" style={{ "paddingTop": "30px" }}>
                    <div className="heading-text">Awesome Mix</div>
                    <div className="description-text" style={{ "paddingTop": "10px" }}>The Modern Day record player is an adaption of the classic record player but instead of using vinyl, this record player will read an RFID card and interface with the Spotify API. Above is the optional UI that can be run if a display screen is setup with the Pi. Built with NodeJS, Spotify API, Socket.io, ReactJS</div>
